      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="max-w-none space-y-10 text-sm leading-relaxed" style={{ color: 'var(--foreground)' }}>
          ...
          <section>
            ...
            <h3 className="text-base font-semibold mt-5 mb-2">a) Account Data</h3>
            <p>
              When you register, we collect your <strong className="">email address</strong> via Supabase authentication. We do not collect your name, phone number, or any social profile unless you voluntarily provide it.
            </p>
            ...
            <p>
              Our hosting provider (Vercel) may collect standard server logs including IP addresses, browser type, and pages visited. This data is used for security and performance monitoring and is subject to <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="hover:underline" style={{color:"var(--primary)"}}>Vercel&apos;s Privacy Policy</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              We do <strong className="">not</strong> sell your data, use it for advertising, or share it with third parties beyond what is listed in Section 4.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm rounded-xl overflow-hidden" style={{border:"1px solid var(--border)"}}>
                <thead>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li><strong className="">Contract performance</strong> — to provide the service you signed up for</li>
              <li><strong className="">Legitimate interests</strong> — for fraud prevention, security, and service improvement</li>
              <li><strong className="">Legal obligation</strong> — to comply with applicable laws</li>
              <li><strong className="">Consent</strong> — for any optional communications (you may withdraw at any time)</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li><strong className="">Account data:</strong> Retained while your account is active. Deleted within 30 days of account deletion.</li>
              <li><strong className="">Screenshots:</strong> Never stored — discarded immediately after AI processing.</li>
              <li><strong className="">Subscription records:</strong> Retained for 7 years for legal and tax compliance purposes.</li>
              <li><strong className="">Usage logs:</strong> Retained for up to 90 days for abuse prevention.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              ...
              <li><strong className="">Rectification:</strong> Request correction of inaccurate data</li>
              <li><strong className="">Erasure:</strong> Request deletion of your account and personal data</li>
              <li><strong className="">Portability:</strong> Receive your data in a structured, machine-readable format</li>
              <li><strong className="">Objection:</strong> Object to processing based on legitimate interests</li>
          ...
          <section>
            ...
            <p>
              FlirtIQ uses minimal cookies. We use a session cookie set by Supabase for authentication. We use <strong className="">localStorage</strong> (not cookies) for language preference and free tier tracking — this data stays in your browser and is not sent to our servers.
            </p>
            <p className="mt-3">

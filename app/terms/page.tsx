      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-10 text-gray-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              You must be at least <strong className="text-white">18 years of age</strong> to use FlirtIQ. By using the Service, you confirm that you are 18 or older. We do not knowingly allow minors to use the Service. If we discover a user is under 18, we will terminate their account immediately.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To access certain features, you must create an account using a valid email address. You are responsible for maintaining the security of your account credentials. You agree to notify us immediately at <a href="mailto:legal@flirtiq.app" className="text-pink-400 hover:underline">legal@flirtiq.app</a> if you suspect any unauthorized use of your account.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">5. Free Tier</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">6. Paid Subscriptions</h2>
            <p>
              FlirtIQ offers paid subscription plans (Weekly, Monthly, Yearly) that provide unlimited analyses. Subscriptions are billed through <strong className="text-white">Lemon Squeezy</strong>, our payment processor and Merchant of Record. By purchasing a subscription, you agree to Lemon Squeezy&apos;s terms at <a href="https://www.lemonsqueezy.com/terms" target="_blank" rel="noopener noreferrer" className="text-pink-400 hover:underline">lemonsqueezy.com/terms</a>.
            </p>
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li><strong className="text-white">Billing:</strong> Subscriptions renew automatically at the end of each billing period (weekly, monthly, or yearly) until cancelled.</li>
              <li><strong className="text-white">Cancellation:</strong> You may cancel at any time through your account or by contacting us. Cancellation takes effect at the end of the current billing period. You retain access until then.</li>
              <li><strong className="text-white">Price changes:</strong> We will notify you at least 14 days before any price change. Continuing to use the Service after the change constitutes acceptance.</li>
              <li><strong className="text-white">Taxes:</strong> Lemon Squeezy, as Merchant of Record, handles all applicable taxes (GST, VAT, sales tax) globally.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              ...
              <li>You request a refund within <strong className="text-white">7 days</strong> of your first purchase and have used fewer than 10 analyses</li>
              <li>Duplicate charges due to a billing error</li>
            </ul>
            <p className="mt-3">
              To request a refund, email <a href="mailto:support@flirtiq.app" className="text-pink-400 hover:underline">support@flirtiq.app</a> with your order ID. Refund requests are processed within 5–7 business days.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">9. AI Disclaimer</h2>
            <p>
          ...
          <section>
            ...
            <p>
              These Terms are governed by the laws of <strong className="text-white">India</strong>, including the Information Technology Act, 2000. Any disputes shall be subject to the exclusive jurisdiction of the courts in India. If you are a user in the European Union, you retain your statutory rights under applicable EU consumer protection laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@flirtiq.app" className="text-pink-400 hover:underline">legal@flirtiq.app</a>
            </p>
          </section>

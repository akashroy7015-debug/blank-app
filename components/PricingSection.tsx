...
const PLANS = [
  ...
  {
    key: 'weekly',
    en: { name: 'Weekly', price: '₹99', period: '/week', desc: 'Perfect for a first date sprint.', cta: 'Start Weekly', features: ['Unlimited analyses', '4 reply styles', 'Compatibility score', 'Strategy tip', 'Priority support'] },
    hi: { name: 'Weekly', price: '₹99', period: '/hafta', desc: 'Pehli date ke liye perfect.', cta: 'Weekly Shuru Karo', features: ['Unlimited analyses', '4 reply styles', 'Compatibility score', 'Strategy tip', 'Priority support'] },
    icon: Zap, highlight: false, badge: null as null | string,
    gradient: 'from-pink-500 to-purple-600', border: 'border-white/8',
  },
  {
    key: 'monthly',
    en: { name: 'Monthly', price: '₹299', period: '/month', desc: 'Most popular for active daters.', cta: 'Start Monthly', features: ['Unlimited analyses', '4 reply styles', 'Compatibility score', 'Strategy tip', 'Priority support', 'Early access to features'] },
    hi: { name: 'Monthly', price: '₹299', period: '/mahina', desc: 'Active daters ke liye sabse popular.', cta: 'Monthly Shuru Karo', features: ['Unlimited analyses', '4 reply styles', 'Compatibility score', 'Strategy tip', 'Priority support', 'Nayi features pehle milegi'] },
    icon: Crown, highlight: true, badge: 'popular' as string,
    gradient: 'from-pink-500 to-purple-600', border: 'border-pink-500/50',
  },
  {
    key: 'yearly',
    en: { name: 'Yearly', price: '₹999', period: '/year', desc: 'Best value — 3 months free!', cta: 'Start Yearly', features: ['Unlimited analyses', '4 reply styles', 'Compatibility score', 'Strategy tip', 'Priority support', 'Early access to features', 'Exclusive tips newsletter'] },
    hi: { name: 'Yearly', price: '₹999', period: '/saal', desc: 'Sabse sasta — 3 mahine free!', cta: 'Yearly Shuru Karo', features: ['Unlimited analyses', '4 reply styles', 'Compatibility score', 'Strategy tip', 'Priority support', 'Nayi features pehle milegi', 'Exclusive tips newsletter'] },
